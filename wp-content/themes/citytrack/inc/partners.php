    ...
    <div id="partner-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-4 img-container">
                    <span class="helper"></span><img class="img-class" src="assets/img/logo-sryhma.jpg" alt="Srhyma logo">
                </div>
                <div class="col-md-2 col-sm-4 img-container">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-md-push-2 col-sm-4 img-container">
                    <span class="helper"></span><img class="img-class" src="assets/img/logo-kesko3.jpg" alt="Kesko logo">
                </div>
