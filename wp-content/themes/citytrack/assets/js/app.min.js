...
function labnolThumb(t){var a="",e='<div class="play"></div>';return a.replace("ID",t)+e}function labnolIframe(){var t=document.createElement("iframe"),a="https://www.youtube.com/embed/HGRl9iePLFc?autoplay=1";t.setAttribute("src",a.replace("ID",this.dataset.id)),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen","1"),this.parentNode.replaceChild(t,this)}!function(t){function a(a){var e=!0;return t("#"+a+" .no-empty").removeClass("warning"),t("#"+a+" .no-empty").each(function(a,n){t(this).val()||(t(this).addClass("warning"),e=!1)}),t("#"+a+" input[type=email]").each(function(a,n){var o=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;o.test(t(this).val())||(t(this).addClass("warning"),e=!1)}),e}function e(a){jQuery.post(ct_ajax.ajaxurl,{action:"ct_email",contact_data:a},function(a){"error"==a?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-contact #contactform").trigger("reset")})}function n(a){jQuery.post(ct_ajax.ajaxurl,{action:"ct_attend",attend_data:a},function(a){"error"==a?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-attend #attendform").trigger("reset")})}t(document).ready(function(){t("#block2 .col-md-6").matchHeight(),t("#block2 .col-sm-12").matchHeight(),t("#block3 .img-container").matchHeight(),t("#partner-block .img-container").matchHeight(),t("#partner-list .img-container").matchHeight(),t("#footer .same-height").matchHeight(),t(".post-body").truncate({maxLines:5,truncateString:"&nbsp;&#8230;",showText:"Read More",hideText:"Read Less"}),t(" #blog #posts .apost .img-container img").addClass("img-responsive"),t("#partner-list .img-container").slice(-4).addClass("col-md-push-2 col-xs-6"),t("#partner-list .img-container").slice(-2).addClass("col-sm-push-3"),t("#partner-block .img-container").slice(-2).addClass("col-md-push-3"),t("#partner-block .img-container").slice(-1).addClass("col-sm-push-4"),t("#contantform-send").bind("click",function(e){e.preventDefault(),a("contactform")&&(t("#modal-contact").modal("hide"),t("#modal-contact #contactform").submit())}),t("#modal-contact #contactform").submit(function(a){return e(t("#modal-contact #contactform").serializeArray()),a.preventDefault(),!1}),t("#modal-contact").on("hidden.bs.modal",function(){t("#modal-contact .no-empty").removeClass("warning")}),t("#attendform-send").bind("click",function(e){e.preventDefault(),a("attendform")&&(t("#modal-attend").modal("hide"),t("#modal-attend #attendform").submit())}),t("#modal-attend #attendform").submit(function(a){return n(t("#modal-attend #attendform").serializeArray()),a.preventDefault(),!1}),t("#modal-attend").on("hidden.bs.modal",function(){t("#modal-attend .no-empty").removeClass("warning")})}),t(document).on("click",".btn-attend",function(){var a=t(this).data("title"),e=t(this).data("desc"),n=t(this).data("date"),o=t(this).data("time");t("#modal-attend #event-name").val(a),t("#modal-attend #event-date").val(n),t("#modal-attend #event-time").val(o),t("#modal-attend .modal-header h1").text("Attend to the "+a),t("#event-desc").text(e)})}(jQuery),document.addEventListener("DOMContentLoaded",function(){var t,a,e=document.getElementsByClassName("youtube-player");for(a=0;a<e.length;a++)t=document.createElement("div"),t.setAttribute("data-id",e[a].dataset.id),t.innerHTML=labnolThumb(e[a].dataset.id),t.onclick=labnolIframe,e[a].appendChild(t)});