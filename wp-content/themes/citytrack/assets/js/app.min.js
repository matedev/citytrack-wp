...
jQuery(document).ready(function(i){function n(n,e){n.each(function(){i(this).offset().top>i(window).scrollTop()+i(window).height()*e&&i(this).find(".cd-timeline-img, .cd-timeline-content").addClass("is-hidden")})}function e(n,e){n.each(function(){i(this).offset().top<=i(window).scrollTop()+i(window).height()*e&&i(this).find(".cd-timeline-img").hasClass("is-hidden")&&i(this).find(".cd-timeline-img, .cd-timeline-content").removeClass("is-hidden").addClass("bounce-in")})}var t=i(".cd-timeline-block"),o=.8;n(t,o),i(window).on("scroll",function(){window.requestAnimationFrame?window.requestAnimationFrame(function(){e(t,o)}):setTimeout(function(){e(t,o)},100)})});
function labnolThumb(t){var e="",a='<div class="play"></div>';return e.replace("ID",t)+a}function labnolIframe(){var t=document.createElement("iframe"),e="https://www.youtube.com/embed/HGRl9iePLFc?autoplay=1";t.setAttribute("src",e.replace("ID",this.dataset.id)),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen","1"),this.parentNode.replaceChild(t,this)}!function(t){function e(e){var a=!0;if(t("#"+e+" .no-empty").removeClass("warning"),t("#"+e+" .no-empty").each(function(e,o){t(this).val()||(t(this).addClass("warning"),a=!1)}),t("#"+e+" input[type=email]").each(function(e,o){var n=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;n.test(t(this).val())||(t(this).addClass("warning"),a=!1)}),t("#"+e+" input[type=number]").each(function(e,o){t(this).val().length>12&&(t(this).addClass("warning"),a=!1)}),t("#user-member").is(":checked")){if(t("#reggroup option.selected").hasClass("group-other"))return a;var o=t("#regcode").val(),n=t("#reggroup option.selected").attr("data-code");n!=o?(t("#regcode").addClass("warning"),a=!1):t("#regcode").removeClass("warning")}return console.log(a),a}function a(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_email",contact_data:e},function(e){"error"==e?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-contact #contactform").trigger("reset")})}function o(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_attend",attend_data:e},function(e){"error"==e?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-attend #attendform").trigger("reset")})}function n(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_register",register_data:e},function(e){"error"==e?t("#error-reg-modal").modal("show"):(t("#thanks-modal").modal("show"),t("#registerform").trigger("reset"),t("#group-option").removeClass("animate"),t("#registerform").data("submitted",!0))})}function r(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_feedback",feedback_data:e},function(e){"error"==e?t("#error-reg-modal").modal("show"):(t("#thanks-modal").modal("show"),t("#feedbackform").trigger("reset"),t("#group-option").removeClass("animate"),t("#feedbackform").data("submitted",!0))})}function i(e){t("body").addClass("loading"),jQuery.post(ct_ajax.ajaxurl,{action:"ct_registration_update",update_data:e},function(e){t("body").removeClass("loading"),"error"==e&&t("#error-reg-modal").modal("show")})}t(document).ready(function(){t("#block2 .col-md-6").matchHeight(),t("#block2 .col-sm-12").matchHeight(),t("#block3 .img-container").matchHeight(),t("#partner-block .img-container").matchHeight(),t("#partner-list .img-container").matchHeight(),t("#footer .same-height").matchHeight(),t(".post-body").truncate({maxLines:5,truncateString:"&nbsp;&#8230;",showText:"Read More",hideText:"Read Less"}),t(" #blog #posts .apost .img-container img").addClass("img-responsive"),t("#partner-list .img-container").slice(-5).addClass("col-sm-push-1"),t("#user-member").change(function(){t(this).is(":checked")?t("#group-option").addClass("animate"):t("#group-option").removeClass("animate")}),t("#reggroup").change(function(){t("#reggroup option").each(function(e,a){t(this).removeClass("selected"),t("#reggroup").val()==t(this).text()&&(t(this).addClass("selected"),t("#user-group").val(t(this).text()),t(this).hasClass("group-other")?(t("#group-code-box").css("display","none"),t("#group-name-box").css("display","block")):t(this).hasClass("group-select")?(t("#group-code-box").css("display","none"),t("#group-name-box").css("display","none")):(t("#group-code-box").css("display","block"),t("#group-name-box").css("display","none")))})}),t("#contantform-send").bind("click",function(a){a.preventDefault(),e("contactform")&&(t("#modal-contact").modal("hide"),t("#modal-contact #contactform").submit())}),t("#modal-contact #contactform").submit(function(e){return a(t("#modal-contact #contactform").serializeArray()),e.preventDefault(),!1}),t("#modal-contact").on("hidden.bs.modal",function(){t("#modal-contact .no-empty").removeClass("warning")}),t("#attendform-send").bind("click",function(a){a.preventDefault(),e("attendform")&&(t("#modal-attend").modal("hide"),t("#modal-attend #attendform").submit())}),t("#modal-attend #attendform").submit(function(e){return o(t("#modal-attend #attendform").serializeArray()),e.preventDefault(),!1}),t("#modal-attend").on("hidden.bs.modal",function(){t("#modal-attend .no-empty").removeClass("warning")}),t("#registerform-send").bind("click",function(a){a.preventDefault(),e("registerform")&&t("#registerform").submit()}),t("#registerform").submit(function(e){var a=t(this);a.data("submitted")===!0?e.preventDefault():(a.data("submitted",!0),n(t("#registerform").serializeArray()),e.preventDefault())}),t("#feedbackform-send").bind("click",function(a){a.preventDefault(),e("feedbackform")&&t("#feedbackform").submit()}),t("#feedbackform").submit(function(e){var a=t(this);a.data("submitted")===!0?e.preventDefault():(a.data("submitted",!0),r(t("#feedbackform").serializeArray()),e.preventDefault())}),t("#modal-attend").on("hidden.bs.modal",function(){t("#modal-attend .no-empty").removeClass("warning")}),t("#btn-reg-update").bind("click",function(e){e.preventDefault();var a=new Array;t("#registrations tr.modified").each(function(e,o){var n=new Object;n.userid=t(this).data("userid"),n.group=t(this).find("#reg-user-group").prop("checked"),n.other=t(this).find("#reg-user-other").val(),a.push(n)}),i(a)}),t("#registrations input").change(function(){t(this).parent().parent("td").css("background-color","green"),t(this).parent().parent("td").addClass("modified"),t(this).parent().parent().parent("tr").css("background-color","lightgreen"),t(this).parent().parent().parent("tr").addClass("modified"),t(this).parent().parent().parent("tr").addClass("modified")})}),t(document).on("click",".btn-attend",function(){var e=t(this).data("title"),a=t(this).data("desc"),o=t(this).data("date"),n=t(this).data("time");t("#modal-attend #event-name").val(e),t("#modal-attend #event-date").val(o),t("#modal-attend #event-time").val(n),t("#modal-attend .modal-header h1").text("Attend to the "+e),t("#event-desc").text(a)})}(jQuery),document.addEventListener("DOMContentLoaded",function(){var t,e,a=document.getElementsByClassName("youtube-player");for(e=0;e<a.length;e++)t=document.createElement("div"),t.setAttribute("data-id",a[e].dataset.id),t.innerHTML=labnolThumb(a[e].dataset.id),t.onclick=labnolIframe,a[e].appendChild(t)});