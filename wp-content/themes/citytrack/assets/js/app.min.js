...
function labnolThumb(t){var e="",a='<div class="play"></div>';return e.replace("ID",t)+a}function labnolIframe(){var t=document.createElement("iframe"),e="https://www.youtube.com/embed/HGRl9iePLFc?autoplay=1";t.setAttribute("src",e.replace("ID",this.dataset.id)),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen","1"),this.parentNode.replaceChild(t,this)}!function(t){function e(e){var a=!0;return t("#"+e+" .no-empty").removeClass("warning"),t("#"+e+" .no-empty").each(function(e,n){t(this).val()||(t(this).addClass("warning"),a=!1)}),t("#"+e+" input[type=email]").each(function(e,n){var o=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;o.test(t(this).val())||(t(this).addClass("warning"),a=!1)}),t("#"+e+" input[type=number]").each(function(e,n){t(this).val().length>12&&(t(this).addClass("warning"),a=!1)}),a}function a(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_email",contact_data:e},function(e){"error"==e?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-contact #contactform").trigger("reset")})}function n(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_attend",attend_data:e},function(e){"error"==e?t("#error-modal").modal("show"):t("#thanks-modal").modal("show"),t("#modal-attend #attendform").trigger("reset")})}function o(e){jQuery.post(ct_ajax.ajaxurl,{action:"ct_register",register_data:e},function(e){"error"==e?t("#error-reg-modal").modal("show"):(t("#thanks-modal").modal("show"),t("#registerform").trigger("reset"),t("#registerform").data("submitted",!0))})}t(document).ready(function(){t("#block2 .col-md-6").matchHeight(),t("#block2 .col-sm-12").matchHeight(),t("#block3 .img-container").matchHeight(),t("#partner-block .img-container").matchHeight(),t("#partner-list .img-container").matchHeight(),t("#footer .same-height").matchHeight(),t(".post-body").truncate({maxLines:5,truncateString:"&nbsp;&#8230;",showText:"Read More",hideText:"Read Less"}),t(" #blog #posts .apost .img-container img").addClass("img-responsive"),t("#partner-list .img-container").slice(-4).addClass("col-md-push-2 col-xs-6"),t("#partner-list .img-container").slice(-2).addClass("col-sm-push-3"),t("#partner-block .img-container").slice(-2).addClass("col-md-push-3"),t("#partner-block .img-container").slice(-1).addClass("col-sm-push-4"),t("#contantform-send").bind("click",function(a){a.preventDefault(),e("contactform")&&(t("#modal-contact").modal("hide"),t("#modal-contact #contactform").submit())}),t("#modal-contact #contactform").submit(function(e){return a(t("#modal-contact #contactform").serializeArray()),e.preventDefault(),!1}),t("#modal-contact").on("hidden.bs.modal",function(){t("#modal-contact .no-empty").removeClass("warning")}),t("#attendform-send").bind("click",function(a){a.preventDefault(),e("attendform")&&(t("#modal-attend").modal("hide"),t("#modal-attend #attendform").submit())}),t("#modal-attend #attendform").submit(function(e){return n(t("#modal-attend #attendform").serializeArray()),e.preventDefault(),!1}),t("#modal-attend").on("hidden.bs.modal",function(){t("#modal-attend .no-empty").removeClass("warning")}),t("#registerform-send").bind("click",function(a){a.preventDefault(),e("registerform")&&t("#registerform").submit()}),t("#registerform").submit(function(e){var a=t(this);a.data("submitted")===!0?e.preventDefault():(a.data("submitted",!0),o(t("#registerform").serializeArray()),e.preventDefault())}),t("#modal-attend").on("hidden.bs.modal",function(){t("#modal-attend .no-empty").removeClass("warning")})}),t(document).on("click",".btn-attend",function(){var e=t(this).data("title"),a=t(this).data("desc"),n=t(this).data("date"),o=t(this).data("time");t("#modal-attend #event-name").val(e),t("#modal-attend #event-date").val(n),t("#modal-attend #event-time").val(o),t("#modal-attend .modal-header h1").text("Attend to the "+e),t("#event-desc").text(a)})}(jQuery),document.addEventListener("DOMContentLoaded",function(){var t,e,a=document.getElementsByClassName("youtube-player");for(e=0;e<a.length;e++)t=document.createElement("div"),t.setAttribute("data-id",a[e].dataset.id),t.innerHTML=labnolThumb(a[e].dataset.id),t.onclick=labnolIframe,a[e].appendChild(t)});